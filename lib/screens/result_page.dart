import 'package:bmi_calculator_praktikum_o/components/buttom_button.dart';
        ...
        children: [
          Expanded(
            child: Container(
              ...
              child: Text('HASIL HITUNG', style: kTittleTextStyle),
            ),
          ),
          Expanded(
            flex: 5,
            child: ReusableWidget(
              ...
              cardChild: Column(
                ...
                children: [
                  ...
                  Expanded(
                    child: Center(
                      child: Text(resultPage.bmiResult, style: kBMITextStyle),
                    ),
                  ),
                  Expanded(
                    child: Center(
